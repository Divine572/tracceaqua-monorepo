...
const screens: OnboardingScreen[] = [
  {
    ...
    description:
      "Whether you're a harvester, processor, transporter, inspector, or consumer, TracceAqua empowers you with transparency.",
  ...
  },
  {
    ...
    description:
      "Consumers can simply scan a QR code to get the full history and origin of their shellfish product.",
  ...
  },
  {
    ...
    title: "How It Works",
    description:
      "We use blockchain technology to record every step of the shellfish journey, from harvest to your plate.",
  ...
  },
  {
    ...
    description:
      "Your trusted partner for traceability and conservation in the Nigerian shellfish supply chain.",
      ...
      <div className="relative z-10 p-6 flex-shrink-0">
        <div className="flex justify-between items-center">
          ...
          <Button
            ...
            size="sm"
            className={cn(
              "text-white hover:bg-white/20 transition-opacity duration-300",
              currentScreen === 0
