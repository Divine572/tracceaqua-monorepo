...
const BatchesTabs = () => {
  return (
    ...
    //           <CardContent>
    //             <div className="space-y-3">
    //               {batch.processingData.qualityTests.map((test, index) => (
    //                 <div key={index} className="p-4 border rounded-lg">
    //                   <div className="flex items-center justify-between mb-2">
    //                     <h4 className="font-medium">{test.testType}</h4>
    //                     <Badge>{test.passed ? "Passed" : "Failed"}</Badge>
    //                   </div>
    //                   <div className="text-sm text-gray-600">
    //                     <div>
    ...
    //           <CardContent>
    //             <div className="space-y-3">
    //               {batch.storageData.qualityChecks.map((check, index) => (
    //                 <div key={index} className="p-4 border rounded-lg">
    //                   <div className="flex items-center justify-between mb-2">
    //                     <h4 className="font-medium">
    //                       {formatDate(check.checkDate)}
    //                     </h4>
    //                     <Badge variant="outline">{check.quality}</Badge>
    //                   </div>
    //                   <div className="text-sm text-gray-600">
    //                     <div>
    //                       <strong>Temperature:</strong> {check.temperature}°C
    //                     </div>
    //                     {check.notes && (
    //                       <div>
